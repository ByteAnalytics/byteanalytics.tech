  ...
  return (
    <section>
      <MaxScreenWrapper style="relative flex lg:flex-row flex-col relative bg-black">
        <div className="w-full lg:w-[67%] polygon-hero lg:justify-start justify-center lg:py-[7rem] lg:ps-[7rem] md:ps-[4rem] py-[4rem] ps-4 lg:pe-[16rem] md:pe-[4rem] pe-4 bg-[#E6F0FC] flex flex-col text-lemongreen text-[77.37px] font-[700] mb-2 relative leading-[85px]">
