...
import img1 from '../../../../../public/training/dat-engineering-hro.svg';
import { CustomImage } from '@/components/global/image';
import { BreadCombLayout } from '@/components/ui/custom-ui/bread-comb-layout';

export const DataEngineeringHero: React.FC = () => {
  return (
    <section>
        ...
        <div className="z-[500] h-fit absolute top-0 lg:left-[2.5rem] left-4 p-4">
          <BreadCombLayout
            routes={[
              ...
              {
                title: 'Data Engneering',
              },
            ]}
          />
        </div>
        <div className="w-full lg:w-[60%] lg:justify-start justify-center py-[7rem] lg:ps-[7rem] md:ps-[4rem] py-[4rem] ps-4 md:pe-[4rem] pe-4 bg-lightgrey flex flex-col text-lemongreen md:text-[77.37px] text-[57px] font-[500] md:font-[700] mb-2 relative leading-[85px]">
