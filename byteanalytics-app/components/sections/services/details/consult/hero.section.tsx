...
import img1 from '../../../../../public/service/consult-hero.svg';
  ...
  return (
    <section>
      <MaxScreenWrapper style="relative flex lg:flex-row flex-col bg-black">
        ...
        <div className="w-full lg:w-[55%] polygon-hero lg:justify-start justify-center py-[7rem] lg:ps-[7rem] md:ps-[4rem] py-[4rem] ps-4 md:pe-[4rem] pe-4 bg-lightgrey flex flex-col text-lemongreen md:text-[77.37px] text-[57px] font-[500] md:font-[700] mb-2 relative leading-[85px]">
